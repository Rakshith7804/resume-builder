...
const Examplepage = ({ 
  ...
  return (
    <div className="w-[100%] bg-gray-800 overflow-hidden dark:bg-slate-900">
          ...
          {visibleIndices.map((index, i) => (
            ...
            >
              <img
                src={images[index]}
                alt={`Slide ${index + 1}`}
                className="w-65% h-150 object-contain rounded-lg shadow dark:filter dark:brightness-900"
              />
            </div>
          ))}
        </div>
